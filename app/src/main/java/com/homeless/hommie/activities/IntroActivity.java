...
public class IntroActivity extends AppIntro {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        addSlide(AppIntroFragment.newInstance("Watchlist'e Hoşgeldin", "Find and Discover your favourite Movies, TV Shows, Actors and more.", R.drawable.ic_launcher_large, Color.DKGRAY));
