package com.homeless.hommie.network;

import com.homeless.hommie.network.movies.Movie;
import com.homeless.hommie.network.movies.MovieCastsOfPersonResponse;
import com.homeless.hommie.network.movies.MovieCreditsResponse;
import com.homeless.hommie.network.movies.NowShowingMoviesResponse;
import com.homeless.hommie.network.movies.PopularMoviesResponse;
import com.homeless.hommie.network.movies.SimilarMoviesResponse;
import com.homeless.hommie.network.movies.TopRatedMoviesResponse;
import com.homeless.hommie.network.movies.UpcomingMoviesResponse;
import com.homeless.hommie.network.people.Person;
import com.homeless.hommie.network.tvshows.AiringTodayTVShowsResponse;
import com.homeless.hommie.network.tvshows.OnTheAirTVShowsResponse;
import com.homeless.hommie.network.tvshows.PopularTVShowsResponse;
import com.homeless.hommie.network.tvshows.SimilarTVShowsResponse;
import com.homeless.hommie.network.tvshows.TVCastsOfPersonResponse;
import com.homeless.hommie.network.tvshows.TVShow;
import com.homeless.hommie.network.tvshows.TVShowCreditsResponse;
import com.homeless.hommie.network.tvshows.TopRatedTVShowsResponse;
import com.homeless.hommie.network.videos.VideosResponse;
...
public interface ApiInterface {
    ...
    Call<com.homeless.hommie.network.movies.GenresList> getMovieGenresList(@Query("api_key") String apiKey);
    ...
    @GET("genre/tv/list")
    Call<com.homeless.hommie.network.tvshows.GenresList> getTVShowGenresList(@Query("api_key") String apiKey);
